                                    ...
                                    echo '   
                                        ...
                                        <div class="grid-8"> 
                                            <article  data-sr="enter top over 1s wait 0.2s">
                                                <div class="post-img">
                                                    <a href="blogdetail.php?q='.$row['id'].'" class="ajax">
                                                   
                                                    <span class="overlay transition2"></span>
                                                    <img style="height:300px" src="admin/media/blogs/'.$row['img'].'" alt="" class="respimg">
                                                    </a>
                                                </div>
                                                <div class="post-info">
                                                    <h3><a href="blogdetail.php?q='.$row['id'].'" class="ajax">'.$row['title'].'</a></h3>
                                                    <p> '.substr($row['detail'],0,200).'.. </p>
                                                </div>
                                            </article>
                                        </div> 
                                ...
                                <div class="sidebar">
                                    <div class="widgets-holder">
                                        ...
                                        while($row = mysqli_fetch_array($result))
                                        {
                                         ...
                                         echo '<li class="cat-item"><a  href="blogdetail.php?q='.$row['id'].'">'.$row['title'].'</a>  <p> '.substr($row['detail'],0,100).'...</p></li> '; } ?>
