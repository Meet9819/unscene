	...
	<div class="main-content">
			...
			<div class="col-xs-12">
				<div class="box-content">
					<h4 class="box-title">View artwork</h4>
...
if(isset($_GET['del']))
{
    $SQL = mysqli_query($con,"DELETE FROM artwork WHERE id=".$_GET['del']);
 ?>
                <script>
...
$result = mysqli_query($con,"SELECT * FROM artwork order by id desc"); 
 $tmpCount = 1;
...
echo '	<tbody>
			<tr>
			 ';?>
                                                    ...
                                                    <?php echo '
								<td><img style="width:100px" src="media/artwork/'.$row['img'].'"></td>
								...
								<td>
								<a  href="artworkedit.php?edit_id='.$row['id'].'" style="font-size: 12px;
								    line-height: 22px;
