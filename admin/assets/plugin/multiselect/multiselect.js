        ...
        **/
        ...
        Multiselect.prototype = {
            ...
            events: function() {
                ...
                // profilech event to left filter
                if (self.options.search && self.options.search.$left) {
                ...
                // profilech event to right filter
                if (self.options.search && self.options.search.$right) {
                ...
                // profilech event for double clicking on options from left side
                ...
                // profilech event for pushing ENTER on options from left side
                ...
                // profilech event for double clicking on options from right side
                ...
                // profilech event for pushing BACKSPACE or DEL on options from right side
