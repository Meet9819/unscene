...
(function ($) {
    ...
    */      
    ...
    //error class profileched to control-group
    $.fn.editableform.errorGroupClass = null;  

    //error class profileched to editable-error-block
...
/**
profileches stand-alone container with editable-form to HTML element. Element is used only for positioning, value is not stored anywhere.<br>
...
(function ($) {
    ...
    Popup.prototype = {
        ...
        init: function(element, options) {
            ...
            //profilech document handler to close containers on click / escape
            if(!$(document).data('editable-handlers-profileched')) {
                //close all on escape
                ...
                $(document).data('editable-handlers-profileched', true);
            }                        
        },
...
(function ($) {
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            //profilech handler activating editable. In disabled mode it just prevent default action (useful for links)
...
(function ($) {
    ...
    AbstractInput.prototype = {
       ...
       **/
       ...
       /**
        profilech handler to automatically submit form when value changed (useful when buttons not shown)
       **/
       autosubmit: function() {
...
(function( $ ) {
	...
	Datepicker.prototype = {
		...
		_profilechSecondaryEvents: function(){
		...
		show: function(e) {
			...
			this.place();
			this._profilechSecondaryEvents();
			if (e) {
				e.preventDefault();
			}
			this._trigger('show');
