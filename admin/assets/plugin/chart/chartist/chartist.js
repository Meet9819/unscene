...
(function(window, document, Chartist) {
   ...
   * @param {Object} parent The parent SVG wrapper object where this newly created wrapper and it's element will be profileched to as child
  ...
  /**
   * Returns an array of class names that are profileched to the current wrapper element. This method can not be chained further.
   *
   * @memberof Chartist.Svg
