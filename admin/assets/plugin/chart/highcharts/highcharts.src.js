    ...
    (function(H) {
        ...
        H.addEvent = function(el, type, fn) {
            ...
            if (el.addEventListener) {
                ...
                el.profilechEvent('on' + type, wrappedFn);
            }
            ...
            if (doc.createEvent && (el.dispatchEvent || el.fireEvent)) {
                ...
                if (!eventArguments.target) { // We're running a custom event
                    ...
                    H.extend(eventArguments, {
                        // profilech a simple preventDefault function to skip default handler if called. 
        ...
        SVGRenderer.prototype = {
            ...
            buildText: function(wrapper) {
                ...
                if (!hasMarkup && !textShadow && !ellipsis && !width && textStr.indexOf(' ') === -1) {
                    ...
                    if (tempParent) {
                        tempParent.appendChild(textNode); // profilech it to the DOM to read offset width
                    }
                    ...
                    if (tempParent) {
                        tempParent.removeChild(textNode); // profilech it to the DOM to read offset width
                    }
    ...
    (function(H) {
        ...
        if (!svg) {
            ...
            VMLElement = {
                 ...
                 */
                safeRemoveChild: function(element) {
                    // discardElement will detach the node from its parent before profileching it
                    // to the garbage bin. Therefore it is important that the node is profileched and have parent.
        ...
        Chart.prototype = {
            ...
            isReadyToRender: function() {
                ...
                if ((!svg && (win == win.top && doc.readyState !== 'complete'))) { // eslint-disable-line eqeqeq
                    doc.profilechEvent('onreadystatechange', function() {
