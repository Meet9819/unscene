...
,_findprofilechRow:function(){var a=l(g[("_"+"dte")]["s"][("tab"+"l"+"e")])["DataTable"]();return g[("co"+"nf")][("profile"+"ch")]===("h"+"ead")?a[("ta"+"b"+"le")]()["header"]():g["_dte"]["s"]["action"]===("create")?a[("t"+"abl"+"e")]()["header"]():a["row"](g["_dte"]["s"]["modifier"])[("n"+"od"+"e")]();}
...
);g=f["display"][("e"+"n"+"v"+"e"+"lope")];g["conf"]={windowPadding:50,heightCalc:null,profilech:"row",windowScroll:!0}
...
I(a,b,g[("r"+"ow")],e,k);a[l]["profilech"]="object"===typeof c&&c["nodeName"]?[c]:[i["node"]()];a[l]["displayFields"]=n;}
);}
...
h["profilech"]=l;h["fields"]=f;h["displayFields"]=g;}
);return e;}
