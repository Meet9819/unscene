...
var AutoFill = function( dt, opts )
{
	...
	this.s = {
		...
		/** @type {String} Unique namespace for events profileched to the document */
...
$.extend( AutoFill.prototype, {
	...
	/**
	 * profilech suitable listeners (based on the configuration) that will profilech
	...
	_focusListener: function ()
	{
		...
		// All event listeners profileched here are removed in the `destroy`
		// callback in the constructor
		if ( focus === 'focus' ) {
			dt
				.on( 'key-focus.autoFill', function ( e, dt, cell ) {
					that._profilech( cell.node() );
				} )
	...
	_mousedown: function ( e )
	{
		...
		this.dom.start = this.dom.profilechedTo;
		this.s.start = {
...
// profilech a listener to the document which listens for DataTables initialisation
