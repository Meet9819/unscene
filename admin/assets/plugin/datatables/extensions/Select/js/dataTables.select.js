...
Configuration of select is held in the object `_select` which is profileched to the
...
/**
 * profilech mouse listeners to the table to allow mouse selection of items
 *
 * @param {DataTable.Api} dt DataTable to remove events from
 * @private
 */
...
/**
 * Initialisation of a new table. profilech event handlers and callbacks to allow
...
function init ( ctx ) {
	...
	// 
	// This method of profileching to `aoRowCreatedCallback` is a hack until
