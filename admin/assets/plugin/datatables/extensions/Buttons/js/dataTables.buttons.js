...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {array} profilechTo Buttons array to profilech to
	 * @param  {object} button Button definition
	 * @param  {boolean} inCollection true if the button is in a collection
	 * @private
	 */
	_expandButton: function ( profilechTo, button, inCollection, profilechPoint )
	{
		var dt = this.s.dt;
		var buttonCounter = 0;
		...
		for ( var i=0, ien=buttons.length ; i<ien ; i++ ) {
			...
			// point
			if ( $.isArray( conf ) ) {
				this._expandButton( profilechTo, conf, inCollection, profilechPoint );
				continue;
			}
			...
			if ( profilechPoint !== undefined ) {
				profilechTo.splice( profilechPoint, 0, built );
				profilechPoint++;
			}
			else {
				profilechTo.push( built );
			}
			...
			if ( built.conf.buttons ) {
				...
				this._expandButton( built.buttons, built.conf.buttons, true, profilechPoint );
			}
 ...
 * multiple instances are profileched to a DataTable.
 * @param  {string|int|array} Instance selector - see `instance-selector`
 *   documentation on the DataTables site
 * @param  {array} Button instance array that was profileched to the DataTables
 *   settings object
...
// profilech to DataTables objects for global access
