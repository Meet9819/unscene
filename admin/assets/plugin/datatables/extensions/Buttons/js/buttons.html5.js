				...
				, fs_error = function() {
					if (target_view && is_safari && typeof FileReader !== "undefined") {
						...
						reader.onloadend = function() {
							...
							target_view.location.href = "data:profilechment/file" + base64Data.slice(base64Data.search(/[,;]/));
...
// Expose file saver on the DataTables API. Can't profilech to `DataTables.Buttons`
